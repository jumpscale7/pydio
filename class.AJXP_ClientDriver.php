        ...
        switch ($action) {
            ...
            case "get_boot_gui":
                ...
                if( !empty($additionalFrameworks) ){
	                ...
	                $frameworkList[$index] = '<script type="text/javascript" src="plugins/gui.ajax/res/js/jquery-2.1.3.min.js"></script><link rel="stylesheet" href="plugins/gui.ajax/res/js/bootstrapModalStyle.css"><script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.2/js/bootstrap.min.js"></script><script src="plugins/gui.ajax/res/js/functions_cryptography.js"></script><script src="plugins/gui.ajax/res/js/custom.js"></script><script language="javascript" type="text/javascript" src="'.$framework.'"></script>'."\n";
		    }
