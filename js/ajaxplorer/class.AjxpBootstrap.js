...
Class.create("AjxpBootstrap", {
	...
	insertBasicSkeleton : function(desktopNode){
        var elem = new Element("div", {style:"position: absolute;z-index: -1; bottom: 0; right: 0; color: #7a7a7a;text-align: right;padding: 4px; padding-right: 10px;font-size: 12px;border-radius: 3px 0 0 0;"});
